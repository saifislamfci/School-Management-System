      ...
      <li class="nav-item">
        ...
        <div id="banner" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header text-danger">Banner</h6>
            <a class="collapse-item font-weight-bold  text-info font-italic" href="add-banner.php">ADD Bannner</a>
            <a class="collapse-item font-weight-bold text-info font-italic" href="all-banner.php">ALL Bannner</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="blog" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header text-danger">Page</h6>
            <a class="collapse-item font-weight-bold  text-info font-italic" href="add-page.php">ADD Page</a>
            <a class="collapse-item font-weight-bold text-info font-italic" href="all-page.php">ALL Page</a>
          </div>
        </div>
      </li>
